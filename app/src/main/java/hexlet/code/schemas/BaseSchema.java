...
public abstract class BaseSchema<T> {
     ...
     * Иными словами добавляет в схему ограничение, которое не позволяет использовать null
     * или пустую строку в качестве значения
     * Метод переопределяется в дочерних классах для изменения возвращаемой схемы
     * @return возвращает схему проверки (В переопределении один из родительских классов)
     * </p>
     */
